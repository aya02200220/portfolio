...
export default function DarkModeMobile() {
  ...
  return (
    <>
      <span
        className="bg-white w-[40px] hover:text-white flex items-center h-[40px] rounded-full lg:hidden justify-center items-center text-black hover:bg-[#C4B0B5] transition-all duration-300 ease-in-out cursor-pointer ml-2 "
        onClick={toggle}
      >
